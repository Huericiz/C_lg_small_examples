...
static double ga[11]={0.0000677106,-0.0003442342,0.0015397681,
       -0.0024467480,0.0109736958,-0.002109075,0.0742379071,
...
double fdistribution(double f,int n1,int n2)
{
  f=fabs(f);
  return beta(n2/2.0,n1/2.0,n2/(n2+n1*f));
}
main()
{
  int n;
  ...
  for(n=1;n<6;n++)
  {
    printf("\nfdistribution(%4.2f,2,3)=%e",1.5*n,fdistribution(1.5*n,2,3));
  }
  getch();
}
