...
void main()
{
   int gdriver=DETECT,gmode,i=0,x,y,area;
   ...
   ellipse(210,123,0,60,13,20);
   ellipse(265,123,0,60,13,20);
   ellipse(210,133,0,360,10,10);
   ellipse(265,133,0,360,10,10);
   ellipse(210,133,0,360,3,3);
   ellipse(265,133,0,360,3,3);
   ellipse(238,160,0,360,10,13);
   arc(240,125,228,312,68);
   arc(240,120,230,310,72);
   setfillstyle(1,4);
