...
#include<graphics.h>
#include<math.h>
#define FNX(x) (int)(x0+(x)*1.0)
#define FNY(Y) (int)(getmaxy()-(y0+(y)*1.0))
#define FNX2(phi) cos(phi)*ac-sin(phi)*bs
#define FNY2(phi) cos(phi)*as+sin(phi)*bc
void elli(int x0,int y0,int a,int b,double theta)
{
  int i;
...
void draw(int x,int y)
{
  ...
  ellipse(x-50,y-10,2077,314,30,120);
  ellipse(x+70,y+80,222,262,52,120);
