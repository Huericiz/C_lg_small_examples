...
double ga1[6]={57568490574.0,-13362590354.0,651619640.7,
              -1121424.18,77392.33017,-184.9052456};
...
double gd1[6]={14472522843.0,2300535178.0,18583304.74,
              99447.43394,376.991397,1.0};
double ge1[5]={1.0,-0.1098628627e-02,
              0.2734510407e-04,-0.2073370639e-05,0.20938872113e-06};
...
double ga2[6]={-2.957821389e+9,7.062834065e+9,-5.23598036e+8,
              1.087988129e+7,-8.632792757e+4,2.284622733e+2};
double gb2[6]={4.0076544269e+10,7.452499648e+8,
              7.189466438e+6,4.7447267e+4,2.261030244e+2,1.0};
double gc2[6]={-4.900604943e+12,1.27527439e+12,-5.153438139e+10,
              7.349264551e+8,-4.237922726e+6,8.511937935e+3};
double gd2[7]={2.49958057e+13,4.244419664e+11,3.733650367e+10,
              2.245904002e+7,1.02042605+5,3.549632885e+2,1.0};
...
double gva2[7]={-0.57721566,0.4227842,0.23069756,
              0.0348859,0.00262698,0.0001075,0.0000074};
double gvb2[7]={1.0,0.15443144,-0.67278579,
              -0.18156897,-0.01919402,-0.00110404,-0.00004686};
double gvc2[7]={1.25331414,-0.07832358,0.02189568,
              -0.01062446,0.00587872,-0.0025154,0.00053208};
double gvd2[7]={1.25331414,0.23498619,-0.0365562,
              0.01504268,-0.00780353,0.00325614,-0.00068245};

double varbessel2(int n,double x)
{
  int i;
  double y,p,b0,b1;
...
main()
{
  ...
  for(n=1;n<6;n++)
  {
    printf("\nvarbessel2(%d,%4.2f)=%e",n,n*0.5,varbessel2(n,n*0.5));
  }
  getch();
}
